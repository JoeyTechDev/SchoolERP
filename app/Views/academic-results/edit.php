...
/**
 * @var \SchoolERP\Models\AcademicResult $result
...
$title = $title ?? 'Edit Academic Result';
...
$caScore = (string) (
    array_key_exists('ca_score', $oldInput)
        ? $oldInput['ca_score']
        : ($result->ca_score ?? '')
);

$examScore = (string) (
    array_key_exists('exam_score', $oldInput)
        ? $oldInput['exam_score']
        : ($result->exam_score ?? '')
);
...
<div class="container py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            ...
            <p class="text-muted mb-0">
                Update the result. Total, grade, and remark will be recalculated automatically.
            </p>
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            ...
            <form
                method="POST"
                action="/SchoolERP/public/academic-results/<?= htmlspecialchars(
                    (string) $result->id,
                    ENT_QUOTES,
                    'UTF-8'
                ) ?>/update"
...
(function () {
    const caInput =
        document.getElementById('ca_score');

    const examInput =
        document.getElementById('exam_score');
